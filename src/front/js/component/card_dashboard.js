    ...
    return (
        ...
        <div className="col" key={id}> 
            ...
            <div className={`card-header d-flex flex-row justify-content-between p-3 ${cardColor}`}>
                ...
                {view === "tasks" && done === false
                ? <div className="card-body" data-bs-toggle="modal" data-bs-target={`#taskdone${id}`}>
            ...
            <div className="modal-dialog modal-dialog-centered">
                <div className="card modal-content p-4">
                    ...
                    <div className="modal-body d-flex flex-column gap-4">                  
                        {/* confirm */}
						<div type="submit" className="card p-2 text-center bg-yellow" data-bs-dismiss="modal" data-bs-toggle="modal" data-bs-target={`#doneResponse${id}`}>
        ...
        {/* response modal */}
		<div className="modal fade" id={`doneResponse${id}`} data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-hidden="true">
            <div className="modal-dialog modal-dialog-centered">
                <div className="card modal-content p-4">
                    {/* title */}
                    <h1>Gooooood</h1>                 
